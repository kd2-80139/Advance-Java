//Used Query String so that now this servlet is not needed
...
//		Date now=new Date();
//		out.println(now);
//		out.println("<a href='allreview'>All Reviews</a>");
//		out.println("<a href='myreviews'>My Reviews</a>");
//		out.println("<a href='sharedreviews'>Shared Reviews</a>");
