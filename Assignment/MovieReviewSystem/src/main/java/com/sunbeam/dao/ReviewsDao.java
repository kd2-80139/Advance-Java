...
import com.sunbeam.interfaces.ReviewsDaoInf;
import com.sunbeam.pojo.Reviews;

public class ReviewsDao extends Dao implements ReviewsDaoInf {
	...
	public Reviews displayById(int id) throws Exception {
